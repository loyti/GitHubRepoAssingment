How to make a basic mongoose server
...
-config
	--route.js
		-module
			-function
		-request url => controller function
	--mongoose.js
		-not a module
		-sets up mongoose connection, schemas, models
		-needs
-controllers dir or controllers.js
	--module
		-object
	--responsible for turn req info into a response
	--needs models
-models dir



If you want to create a sample db basic instructions with notes below
