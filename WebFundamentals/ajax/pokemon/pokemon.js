$(document).ready(function(){
    for (var i = 1; i < 152; i++){
        $(".pokemonI").append("<img src=\"http://pokeapi.co/media/img/" + i + ".png\" class=\"pokemonNew\" id=\"" + i + "\">");
    };
    $('.pokemonI').on('click', '.pokemonNew', function(e){
        ...
        $.get('http://pokeapi.co/api/v2/pokemon/' + pid + "/", function(pokedex){
            ...
            $('.pokeI').append('<img src=\"' + pokedex.sprites.front_default + '\">');
